...
namespace IstanbulNs.Controllers
{
    ...
    public class ServicesController : ControllerBase
    {
        ...
        {
            var queryable = (from service in _db.Services.AsParallel()
                             join servicename in _db.ServiceNames.AsParallel() on service.Id equals servicename.ServiceId
                             join serviceinfo in _db.ServiceInfo.AsParallel() on service.Id equals serviceinfo.ServiceId
                             ...
                             select new
                             {
                                 ...
                                 Picture = service.ServicePictures,
            ...
            return Ok(new ReturnMessage(data: queryable.ToList()[0]));
        }
        [HttpGet("all/{langId}")]
